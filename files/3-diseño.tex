...
\todo[inline]{Grid search crossvalidation}
...
Cuatro resultados distintos son posibles por muestra y clase concreta: true positive (identificada correctamente como perteneciente a la clase), false positive (identificada incorrectamente como perteneciente a la clase), false negative (identificada incorrectamente como no perteneciente a la clase), y true negative (identificada correctamente como no perteneciente a la clase). Una forma común de visualizar estos resultados es mediante una matriz de confusión. \todo{Add example confusion matrix}
...
\todoin{AFTER CH 4 \\
proceso de herramienta para gráficos \\
> stress test \\
> codecarbon-viz}
